...
В этом репозитории размещен результат работы над сквозным заданием курса DevOps Upgrade. Изначально было выдано приложение SlurmTalks в виде исходных кодов фронтенда и бекенда. В ходе работы над заданием я сделал:

1. Разобрался как устанавливать приложение на сервера без использования контейнеров
1. Составил Dockerfile-ы для приложения. Сделал развертывание локально в Docker Compose
1. Сделал развертывание в Docker на сервера с помощью Ansible
1. Сделал развертывание в Kubernetes с помощью Helm чартов и Gitlab CI
